...
Explosion::Explosion(QGraphicsItem *parent) : QObject(), QGraphicsPixmapItem(parent), currentSpriteIndex(0) {
    ...
    connect(animationTimer, &QTimer::timeout, this, &Explosion::animate);
